export default function Menu({ home = false }) {
  return (
    <div className='card menu h-60px md:flex-none md:w-90px md:h-600px md:mr-20px 2xl:w-120px 2xl:h-850px 2xl: 2xl:mr-50px flex flex-row items-center justify-between md:flex-col'>
      ...
      ></a>
      <a
        className='iconfont iconenglish cursor-pointer flex-none w-20px h-20px text-20px mr-15px md:mr-0 md:mb-20px 2xl:mb-50px md:w-30px md:h-30px md:text-30px'
      ></a>
    </div>
  );
}
