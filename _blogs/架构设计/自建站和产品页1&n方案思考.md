...
- 无版本管理
- typescript 不友好（可通过插件支持 ts：https://github.com/module-federation/core/tree/main/packages/typescript）
...
建立一个 demo，包含两个 repo。一个是由 next.js 构建的主站 repo，另一个是由 vite 构建的产品 repo（生成页面和 npm 包）
