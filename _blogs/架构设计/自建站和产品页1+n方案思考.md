...
需求基本是微前端要解决的问题，只是我的需求相比一些公司场景，极端情况要少一些，如跨 vue 和 react 搭建，权限问题 等。
...
module.exports = {
  plugins: [
    new ModuleFederationPlugin({
      name: "host",
      remotes: {
        "remote-app": "remote@http://localhost:3000/remoteEntry.js",
      },
    }),
  ],
};
...
查阅 webpack 的 [Module Federation](https://webpack.docschina.org/concepts/module-federation/#separate-builds-per-page) 文档时，发现解决我的这种场景是他的设计初衷之一。
